      ...
      <div className="project-body">
        ...
        <div className="project-card">
          ...
          <div className="project-info">
            ...
            <div className="project-developer project-info-title">
              Developer: <h6>{project.developer.username}</h6>
            </div>
            <div className="project-date project-info-title">
              Uploaded : {project.date}
            </div>
            <div className="project-tech-used project-info-title">
              <h4>Tech Used:</h4>
              {project.technologiesUsed.map((tech, index) => (
                <span key={index} className="project-tech-logo">
                  {tech}
                </span>
              ))}
            </div>
        ...
        <div className="project-wishlish-bar">
          <div className="project-wishlist-title">
            You can save this project to your list and can also follow developer
          </div>
